...
// }, [user]);
  ...
  try {
    const response = await fetch('/api/leads', {
      ...
      body: JSON.stringify({ request : conversation }),
    });
    ...
    if (data.success) {
      setResult(data);
      setConversation('');
      window.alert("Lead created successfully:\n" + JSON.stringify(data.result.leadss, null, 2));
    } else {
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          The AI will identify restaurant names, contact details, interested products, and other valuable data.
        </p>
      </div>
